package de.svenleonhard.tournamentmanager.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.svenleonhard.tournamentmanager.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.svenleonhard.tournamentmanager.repository.UserRepository.USERS_BY_EMAIL_CACHE);
