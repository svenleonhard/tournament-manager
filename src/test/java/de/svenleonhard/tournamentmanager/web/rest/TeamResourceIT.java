...
public class TeamResourceIT {
    ...
    private static final Integer DEFAULT_PLAYERS_AMOUNT = 1;
    private static final Integer UPDATED_PLAYERS_AMOUNT = 2;
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().teamName(DEFAULT_TEAM_NAME).playersAmount(DEFAULT_PLAYERS_AMOUNT);
        return team;
    }
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().teamName(UPDATED_TEAM_NAME).playersAmount(UPDATED_PLAYERS_AMOUNT);
        return team;
    }
    ...
    public void createTeam() throws Exception {
        ...
        // Create the Team
        restTeamMockMvc
            .perform(post("/api/teams").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(team)))
        ...
        assertThat(testTeam.getPlayersAmount()).isEqualTo(DEFAULT_PLAYERS_AMOUNT);
    }
    ...
    public void getAllTeams() throws Exception {
        ...
        restTeamMockMvc
            ...
            .andExpect(jsonPath("$.[*].playersAmount").value(hasItem(DEFAULT_PLAYERS_AMOUNT)));
    }
    ...
    public void getTeam() throws Exception {
        ...
        restTeamMockMvc
            ...
            .andExpect(jsonPath("$.playersAmount").value(DEFAULT_PLAYERS_AMOUNT));
    }
    ...
    public void updateTeam() throws Exception {
        ...
        updatedTeam.teamName(UPDATED_TEAM_NAME).playersAmount(UPDATED_PLAYERS_AMOUNT);

        restTeamMockMvc
            .perform(put("/api/teams").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(updatedTeam)))
            .andExpect(status().isOk());
        ...
        assertThat(testTeam.getPlayersAmount()).isEqualTo(UPDATED_PLAYERS_AMOUNT);
    }
    ...
    public void updateNonExistingTeam() throws Exception {
        ...
        restTeamMockMvc
            .perform(put("/api/teams").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(team)))
            .andExpect(status().isBadRequest());
